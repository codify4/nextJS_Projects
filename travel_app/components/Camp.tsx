...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoinded }: CampProps) => {
  return (
...
const Camp = () => {
  return (
    <section className='flex flex-col relative 2xl:max-container py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      <div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        <CampSite 
          backgroundImage="bg-bg-img-1"
          title="Dajti Camp Site"
          subtitle="Tirana, Albania"
          peopleJoinded="100+ Joined"
        />

        <CampSite 
          backgroundImage="bg-bg-img-2"
          title="Dajti View Site"
          subtitle="Atop of the Mountain"
          peopleJoinded="100+ Joined"
        />
      </div>
